...
$('#' + 'projectForm').submit( function( event ) {
    ...
    $.ajax({
        ...
        type: 'get',
        data: $('#projectForm').serialize(), // Remember that you need to have your csrf token included
        dataType: 'json',
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                for (let i = 0; i < $imageList.length; i++) {
                    ...
                    $fileList = 'fileList_BG_' + i;

                    $('#' + 'backgroundList').append(
                        '<div class="button-24" id="' 
                        + $fileList 
                        + '" data-url="' 
                        + $url
                        + '" data-filename="'
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                for (let i = 0; i < $imageList.length; i++) {
                    ...
                    $filename = $imageList[i]['filename'];
                    $url = $imageList[i]['url'];
                    $fileList = 'fileList_DLB_' + i;

                    $('#' + 'dialogBoxList').append(
                        '<div class="button-24" id="' 
                        + $fileList 
                        + '" data-url="' 
                        + $url
                    ...
                    $('#sel_DlogBoxImg').append('<option value="' 
                        + $url 
                        + '"' 
                        +'>' 
                        + $filename 
...
$(document).ready(function() {
    ...
    $(document).ready(function(){
        ...
        $('#' + 'num_dlogbox_scale').on('input', function (event) {
            ...
            //Retrieve scale from num input
            $scale_dLogBox = $(this).val();
            //Sycn scale range button 
    ...
    $(document).ready(function(){
        ...
        //Store dialog default setting to id
        ...
        $hueb_col_dLog.on('change', function(color) {
            ...
            $fontColor_dLog = color;

            //Issues - Unable retrieve global position y variable
        ...
        function checkDlog($text_dLog, $fontColor_dLog, $fontSize_dLog, $posY_dLog, $maxW_dLog, $lineH_dLog) {
            $hasDlog = $('#' + 'txt_dlog').val();

            //If dialog exist, show dialog
            if ($hasDlog != null) {
    ...
    $(document).ready(function(){
        ...
        $posY_nameplt = parseInt($('#' + 'num_nameplt_posy').val());
        ...
        $('#' + 'num_nameplt_posy').on('input', function() {
            ...
            $posY_nameplt = $(this).val();

            //Sync range value
            $('#' + 'ran_nameplt_posy').val($posY_nameplt);
        ...
        $('#' + 'ran_nameplt_posy').on('input', function() {
            ...
            //Sync range value
            $('#' + 'num_nameplt_posy').val($posY_nameplt);
        ...
        $('#' + 'num_nameplt_posx').on('input', function() {
            ...
            $posX_nameplt = $(this).val();

            //Sync range value
            $('#' + 'ran_nameplt_posx').val($posX_nameplt);
        ...
        $('#' + 'ran_nameplt_posx').on('input', function() {
            ...
            //Sync range value
            $('#' + 'num_nameplt_posx').val($posX_nameplt);
...
$(document).ready(function() {
    $('#' + 'btn_addLine').click(function(event){
        ...
        $('#scriptLog').append('<div id="' 
            + $scriptContainer 
            + '" class="flex-row script-code-container" data-arrPos="'
            + $arrCount 
            + '"></div>'
        );
    
        $('#' + $scriptContainer).append('<div id="'
            + $scriptLabel 
            + '" class="script-code-label line-label-color" data-label="'
            + $label
            + '" onClick="showScriptInfo('
            + $scriptContent
            + ','
            + $scriptLabel
            + ')"></div>'
        ...
        $('#' + $scriptContainer).append('<div id="'
            + $scriptContent 
            + '" class="script-code-bar" onClick="showScriptInfo(' 
            + $scriptContent
            + ','
            + $scriptLabel 
            + ')"></div>'
        ...
        $('#' + $scriptContainer ).append('<div id="'
            + $removeSC
            + '" class="script-code-x-btn-container"></div>'
        );
    
        $('#' + $removeSC).append('<div id="'
            + $removeSB
            + '" class="cross" onclick="removeScript('
            + $scriptContainer  
            + ','
            + $arrCount 
            + ')"></div>'
    ...
    $('#' + 'btn_showBackground').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label bg-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
                ...
                $('#' + $scriptContainer  ).append('<select id="'
                    + $selectionList 
                    + '" class="script-code-select-bar" onchange="showScriptInfo(' 
                    + $selectionList
                    + ','
                    + $scriptLabel 
                    + ')"></select>'
                ...
                for (let i = 0; i < $imageList.length; i++) {
                    $('#' + $selectionList).append('<option class="script-code-select-bar-opt" value="' 
                        + $imageList[i]['url'] 
                        + '">' 
    ...
    $('#' + 'btn_showChar1').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label char-1-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
    ...
    $('#' + 'btn_showChar2').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label char-2-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
    ...
    $('#' + 'btn_showChar3').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label char-3-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
    ...
    $('#' + 'btn_showChar4').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label char-4-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
    ...
    $('#' + 'btn_playAudio').click(function( event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                $('#' + $scriptContainer).append('<div id="'
                    + $scriptLabel 
                    + '" class="script-code-label audio-label-color" data-label="'
                    + $label
                    + '" onClick="showScriptInfo('
                    + $selectionList
                    + ','
    ...
    $('#' + 'btn_showMessage').click(function(event) {
        ...
        $('#' + $scriptContainer).append('<div id="'
            + $scriptLabel 
            + '" class="script-code-label effect-label-color" data-label="'
            + $label
            + '" onClick="showScriptInfo('
            + $scriptContent
            + ','
...
$(document).ready(function() {
    ...
    function drawCharacter($selectedScript, $char_posX, $char_posY, $char_scale) {
        ...
        $charLayer = retrieveCharLayer($selectedScript);

        //Get canvas to draw character image
        $char_cav = document.getElementById('cav_char' + $charLayer);
        $char_ctx = $char_cav.getContext('2d');

        //Renew retrieve character image
        $char_img = new Image();
...
$(document).ready(function() {
    ...
    $('#' + 'btn_saveProject').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function( _response ){
                ...
                console.log(_response)
                alert('The game script is success save');
                //console.log(newData)
    ...
    function writeDefaultSetting($arr) {
        ...
        $data_nameplt_posx = $('#' + 'vsn_defSetting').attr('data-nameplt-posx');

        //Step 1
        $arr.push('init:');

        $arr.push('! Dialog Box Setting !');

        //Step 2 : Dialog box image
        if (typeof $data_dlogbox_filename !== typeof undefined && $data_dlogbox_filename !== false) {
         ...
         if (typeof $data_dlogbox_posx !== typeof undefined && $data_dlogbox_posx !== false) {
        ...
        if (typeof $data_dlogbox_posy !== typeof undefined && $data_dlogbox_posy !== false) {
        ...
        if (typeof $data_dlogbox_scale !== typeof undefined && $data_dlogbox_scale !== false) {

            $temp = $tab + '> ' + 'dialog.box.scale = ' + $data_dlogbox_scale;
            $arr.push($temp);
        }

        $arr.push('! Dialog Setting !');

        //Step 6: Dialog font size
        if (typeof $data_dlog_font_size !== typeof undefined && $data_dlog_font_size !== false) {
        ...
        if (typeof $data_dlog_font_color !== typeof undefined && $data_dlog_font_color !== false) {
        ...
        if (typeof $data_dlog_line_height !== typeof undefined && $data_dlog_line_height !== false) {
        ...
        if (typeof $data_textbox_width !== typeof undefined && $data_textbox_width !== false) {
        ...
        if (typeof $data_textbox_posx !== typeof undefined && $data_textbox_posx !== false) {
        ...
        if (typeof $data_textbox_posy !== typeof undefined && $data_textbox_posy !== false) {

            $temp = $tab + '> ' + 'dialog.yaxis = ' + $data_textbox_posy;
            $arr.push($temp);
        }

        $arr.push('! Nameplate Setting !');

        //Step 11: Nameplate font size
        if (typeof $data_nameplt_font_size !== typeof undefined && $data_nameplt_font_size !== false) {
        ...
        if (typeof $data_nameplt_font_color !== typeof undefined && $data_nameplt_font_color !== false) {
        ...
        if (typeof $data_nameplt_posy !== typeof undefined && $data_nameplt_posy !== false) {
        ...
        if (typeof $data_nameplt_posx !== typeof undefined && $data_nameplt_posx !== false) {
    ...
    function writeScript($arr, $scriptQuery) {
        ...
        for ($currPos = 0; $currPos <= $scriptQuery.length; $currPos++) {
            ...
            $checkLabel = $('#' + 'scriptLabel_' + $currPos).attr('data-label');
            ...
            if ($checkLabel == 'HC1' || $checkLabel == 'HC2' || $checkLabel == 'HC3' || $checkLabel == 'HC4' || 
                $checkLabel == 'HM' || $checkLabel == 'SM' || $checkLabel == 'SA' || $checkLabel == 'HBG' ){
...
function canvasDrawDialog(text, fontColor, fontSize, posY, maxWidth, lineHeight) {
    ...
    console.log("The posX :" + posX);

    //Clean dialog canvas screen to default
    ctx.clearRect(0, 0, cav.width, cav.height);

    var font = fontSize + 'px' + ' ' + 'Comic Sans MS';
